...
def create_reminder(request):
    if request.method == 'POST':
        ...
        if reminder_form.is_valid():
            ...
            return render(
                request,
                'bookstore1/create_reminder.html',
                {
...
def quote_list(request):
    ...
    return render(request, 'bookstore1/pagination_quotes.html', context)
...
class AuthorListView(generic.ListView):
    ...
    paginate_by = 200
    template_name = 'bookstore1/pagination_authors.html'


class AuthorDetailView(generic.DetailView):
    model = Author
    template_name = 'bookstore1/detail_author.html'
